 ...
 * Python, PyCharm Community Edition, webapp2, RequestHandler
...
知っている方がサーバとのやりとりを実装する上での落とし穴にははまりにくくなります。
 ...
 * Androidアプリから講義データの管理を行う方法を調べてみましょう。
 * 受講生のアカウントから講義の質問や感想を送れるようにしてみましょう。

==== 過去の授業のサーバサイド実装

 第13章「センサー」第14章「ネットワークプログラミング」などで、
講師が用意したサーバが登場しています。
同じ機能を持つWebサーバを自力で実装してみましょう。
